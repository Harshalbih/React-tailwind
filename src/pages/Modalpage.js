...
function Modalpage() {
    ...
    const modal = <Modal onClose={handleClose} actionBar={<Button primary >I accept</Button>}>
      <p>
        Please accept terms and conditions The website you are visiting is protected and  are visiting is protected and accelerated by Incapsula. Your rotected and accelerated by Incapsula. Your  computer may have been infected by malware and therefore flagged by the Incapsula network. Incapsula displays this page for you to verify that an actual human is the source of the traffic to this site, and not malicious software.
