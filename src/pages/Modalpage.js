...
function Modalpage() {
    ...
    const modal = <Modal onClose={handleClose} actionBar={<Button primary >I accept</Button>}>
      <p>
        ...
        Just click the I'm not a robot checkbox to pass the security check.  to pass the security check. Incapsula will remember you and will not show this page again. We recommend you run a virus and malware scan on your computer to remove any infection.
      </p>
    </Modal>
